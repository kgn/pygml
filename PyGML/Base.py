...
class GML(object):
    ...
    def save(self, file):
        ...
        if self.__strokes:
            ...
            for stroke in self.iterStrokes():
                if stroke._shouldStore():
                    stroke._store(drawing)
